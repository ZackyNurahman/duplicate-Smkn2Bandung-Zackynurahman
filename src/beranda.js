...
const Beranda = () => {
    return ( 
        ...
        <div className=" py-60 px-48 font text-4xl text-white font-bold  font-sans flex ">
            ...
            <button class="my-5 text-lg bg-transparent hover:bg-blue-500 text-white font-semibold hover:text-[#181823] py-2 px-4 border-white border-2 hover:border-transparent rounded">

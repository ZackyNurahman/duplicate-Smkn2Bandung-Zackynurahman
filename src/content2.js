...
const Content2 = () => {
    return ( 
        ...
        <div className='text-center mt-60 font-sans text-3xl font-bold animate__animated animate__bounceInDown animate__delay-2s'>
            <h1>VISI AND MISI</h1>
            </div>
            <div className='flex flex-row gap-8 justify-center mt-12 animate__animated animate__bounceInDown animate__delay-2s'>
            <div href="#" className="block max-w-xl p-6 bg-white border hover:border-green-600 border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
      ...
      <div href="#" className="block max-w-xl p-6 bg-white border hover:border-blue-600 border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">

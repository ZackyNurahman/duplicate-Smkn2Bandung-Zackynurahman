...
const Pengertian7 = () => {
    return ( 
        ...
        <div className="ml-16 justify-center mt-24 my-8  flex gap-40">
            ...
            <h1 className='mb-2'>SMART PARKING</h1>
            <div className="text-lg">
            <p><span className='text-xl font-bold'>SMART PARKING</span> adalah perangkat yang digunakan untuk sensor suatu hal yang apabila digunakan sensor  tersebut akan berbunyi dan bunyi nya itu seperti suara lonceng.</p>
            </div>  
        ...
        <button className="bg-blue-500 text-white hover:bg-blue-400 rounded-l-lg px-4 py-2 mx-0 outline-none focus:shadow-outline "><Link to={'/pengertian6'} className='flex '><AiOutlineArrowLeft className='flex my-auto mr-2'/> Back</Link></button>
        ...
        <button className="bg-blue-500 text-white hover:bg-blue-400 rounded-r-lg px-4 py-2 mx-0 outline-none focus:shadow-outline"><Link to={'/pengertian8'} className='flex'>Next <AiOutlineArrowRight className='flex my-auto ml-2' /></Link></button>
      </div>
        <Footer />
        </>
     );

...
const Pengertian15 = () => {
    return ( 
        ...
        <div className="ml-16 justify-center mt-24 my-8  flex gap-40">
            ...
            <h1 className='mb-2'>HOME AUTO WATERING RELAY</h1>
            <div className="text-lg">
            <p><span className='text-xl font-bold'>HOME AUTO WATERING RELAY</span> adalah perangkat yang berfungsi untuk Proses penyiraman tanaman umumnya dilakukan secara manual berapapun volume air yang dibutuhkan oleh tanaman. Penelitian ulang ini membahas tentang prototipe otomatis dan sistem yang memiliki fungsi menyiram tanaman berdasarkan tingkat kelembaban tanah. Metode yang digunakan adalah prototyping yang disesuaikan dengan tujuan penelitian. Prototipe dan sistem dibangun dengan mikrokontroler, sensor kelembaban tanah, relay dan solenoid valve, yang terintegrasi dengan platform IoT aplikasi Blynk dan Thingspeak.</p>
            </div>  
        ...
        <button className="bg-blue-500 text-white hover:bg-blue-400 rounded-l-lg px-4 py-2 mx-0 outline-none focus:shadow-outline "><Link to={'/pengertian14'} className='flex '><AiOutlineArrowLeft className='flex my-auto mr-2'/> Back</Link></button>
        ...
        <button className="bg-blue-500 text-white hover:bg-blue-400 rounded-r-lg px-4 py-2 mx-0 outline-none focus:shadow-outline"><Link to={'/pengertian1'} className='flex'>Next <AiOutlineArrowRight className='flex my-auto ml-2' /></Link></button>
      </div>
        <Footer />
        </>
     );

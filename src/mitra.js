...
const Mitra = () => {
    return ( 
        ...
        <div className="flex xl:flex-row xl:ml-0 sm:flex-col sm:ml-[-39px] justify-center w-full mb-20 gap-6 mt-10 animate__animated animate__bounceInUp animate__delay-3s">
        <div className="card ">
        <div className="content xl:ml-0 sm:ml-[40px]">
          <h2>ITB</h2>
        ...
        <div className="flex justify-center xl:flex-row sm:flex-col xl:ml-0 sm:ml-[-39px] w-full mb-40 gap-6 mt-10 animate__animated animate__bounceInUp animate__delay-3s">
        <div className="card">
        <div className="content xl:ml-0 sm:ml-[40px]">
          <h2>BINARY</h2>

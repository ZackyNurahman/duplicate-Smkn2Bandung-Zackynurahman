...
<div className=" mt-7 flex xl:flex-row sm:flex-col gap-[2px]">
        ...
        <div className="tugas mt-7  xl:flex-row flex sm:flex-col">
        ...
        <div className="tugas mt-7 flex xl:flex-row sm:flex-col">
        ...
        <TekidoCard judul="TIMBANGAN DIGITAL" kategori="IOT WORKSHOP KIT" caption=" alat pendeteksi status objek." harga="Rp1.750.000" foto="w-full rounded-l-lg box box-16" link1={<a href='https://www.tokopedia.com/lskkstore/center-of-grafity-timbangan-digital-alat-praktek-smk?extParam=whid%3D8931991'target='_blank'> Tokopedia</a>} link2={<a className='cursor-no-drop' >Blibli</a>} link3={<a  className='cursor-no-drop'>Telkom</a>}/>
        </div>
        <div className="tugas mt-7 flex xl:flex-row sm:flex-col">
        <TekidoCard judul="SENSOR GERAK" kategori="IOT WORKSHOP KIT" caption=" sensor pendeteksi perubahan bentuk." harga="Rp1.650.000" foto="w-full rounded-l-lg box box-17" link1={<a href='https://www.tokopedia.com/lskkstore/robotic-flex-sensor-sensor-gerak-alat-praktek-smk?extParam=whid%3D8931991' target='_blank'> Tokopedia</a>} link2={<a className='cursor-no-drop'>Blibli</a>} link3={<a  className='cursor-no-drop'>Telkom</a>}/>
        </div>
        </div>

...
<div className="tugas mt-7 gap-[2px]">
        ...
        <div className="second">
          ...
          <p className='text-sm'>ENVIROMENTAL SENSOR</p>
        </div>
        </div>
        </div>
        </div>
        ...
        <p className='text-xl'><Link to={'/pengertian8'}>IoT Workshop Kit</Link></p>
          <p className='text-sm'>HOME AUTOMATION</p>
        </div>
        </div>
        </div>
        </div>
        ...
        <p className='text-xl'><Link to={'/pengertian10'}>IoT Workshop Kit</Link></p>
          <p className='text-sm'>SMARTCARD SAGA</p>
        </div>
        </div>
        </div>
        </div>
        ...
        <p className='text-xl'><Link to={'/pengertian14'}>IoT Stater Kit</Link></p>
          <p className='text-sm'>HOME AUTO WATER PUMP</p>
        </div>
        </div>
        </div>
        </div>

...
const Content3 = () => {
    return ( 
        <div className="w-full flex justify-center mb-6 gap-6 my-24 ">        
        <a className="block rounded-xl border animate__animated animate__backInLeft animate__delay-1s font-bold p-4 w-[25%] shadow-xl sm:p-6 lg:p-8" >
        ...
        <a className="block rounded-xl border animate__animated animate__backInUp  animate__delay-1s font-bold p-4 w-[25%] shadow-xl sm:p-6 lg:p-8" >
        ...
        <a className="block rounded-xl border animate__animated animate__backInRight animate__delay-1s font-bold p-4 w-[25%] shadow-xl sm:p-6 lg:p-8" >

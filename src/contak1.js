...
const handleSubmit = (event) => {
    ...
    return ( 
        <>
        <div className='xl:ml-36 xl:mt-0 sm:ml-[-58px] mt-[-5rem] '>
        <div className='contact xl:ml-[5rem] sm:ml-0 flex xl:flex-row sm:flex-col'>
        ...
        <div className='contact4 xl:w-[600px] xl:ml-[20px] xl:mt-[15px] sm:w-[25rem] mt-10 ml-[4rem]'>

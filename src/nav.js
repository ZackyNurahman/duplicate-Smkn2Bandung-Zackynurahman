...
function Nav() {
  ...
  return (
    <nav className={navbarClass} class=' text-lg'>
      ...
      <ul>
        <li className='flex items-center gap-3 text-white text-lg font-medium'><img src={logo} alt="logo" className="w-25 h-10" />LSKK</li>
      </ul>
      <ul className='ml-72'>
        ...
        <li>  <a href='/tekido' className='hover:text-blue-300'>Tekido</a></li>
